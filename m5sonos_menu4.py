...
2:
  {0:"shuffle neil young",
   1:"shuffle jason isbell",
   2:"shuffle patty griffin",
   3:"shuffle israel nash",
   4:"shuffle gillian welch",
   5:"shuffle counting crows",
   6:"shuffle courtney barnett",
   7:"shuffle dar williams"},
3:
  {0:"station wnyc",
   1:"station patty griffin",
   2:"station neil young",
   3:"station quickmix",
   4:"station rem",
   5:"station lucinda williams",
   6:"station counting crows",
   7:"station dar williams"}
}
...
while 1:
  ...
  if flag:
    ...
    action = new_actions[page][action_num]
    print("action =", action)
    if 'menu' in action:
